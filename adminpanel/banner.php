...
$field['lcap']=get_entity($_REQUEST['lcap']);
$field['limage']=$image;	
	...
	<? } ?>
	  <div class="row">
		...
		<? if(($_REQUEST['action']=="add") || ($_REQUEST['action']=="edit"))
           ...
           <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Caption<font color="red"></font>:</label>
                  <div class="col-sm-10">
                   <textarea id="lcap" name="lcap" placeholder="Caption"  rows="4" cols="83" style=" border: 1px solid #000;"><?=get_symbol($res_edit[0]["lcap"])?></textarea>
					<label for="lcap" id="mcontenterrr" class="error" style="display:none;">Please enter Caption</label>
                  </div>
           </div> 	
			...
			<div class="form-group">
			 ...
			 <div class="form-group">
                 ...
                 <div class="col-xs-10 viewtext"><?=get_symbol($res_view[0]["lcap"])?></div>   
       		</div>	
            ...
            <div class="box-header">
              <h3 class="box-title"><?=$pagetitle?></h3>
			   <a href="<?=$pagename?>?action=add"><button type="submit" class="btn btn-success pull-right"><i class="fa fa-plus-square"></i>&nbsp;&nbsp;Add Banner</button></a>
	  </br/>
            </div>
